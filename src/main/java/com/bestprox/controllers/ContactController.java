...
import com.bestprox.forms.ContactForm;
import com.bestprox.forms.ContactSearchForm;
...
public class ContactController {
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result,
        ...
        contact.setDesription(contactForm.getDescription());
        ...
        // set message to be displayed only.
        session.setAttribute("message", Message.builder()
    ...
    public String viewContacts(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        logger.info("all contacts {}", pageContacts);
    ...
    public String searchHandler(
        ...
        if (contactSearchForm.getField().equalsIgnoreCase("name")) {
            ...
            pageContacts = contactService.searchByPhoneNumber(contactSearchForm.getValue(), page, size, sortBy,
                    direction, user);
        }
    ...
    public String updateContact(@PathVariable("contactId") String contactId,
        ...
        con.setDesription(contactForm.getDescription());
        con.setFevorite(contactForm.isFevorite());
        con.setWebsiteLink(contactForm.getWebsiteLink());
        con.setLinkedLink(contactForm.getLinkedLink());
        // process image

...
import com.bestprox.entities.Providers;
import com.bestprox.entities.User;
import com.bestprox.helpers.AppConstants;
import com.bestprox.repositoris.UserRepo;
...
public class OAuthAuthenticationSucessHandler implements AuthenticationSuccessHandler{
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
            Authentication authentication) throws IOException, ServletException {
                ...
                logger.info(authorizedClientRegistrationId);
                 ...
                 if(authorizedClientRegistrationId.equalsIgnoreCase("google")){
                    ...
                    user.setAbout("Account has benn creted with google");
                    ...
                    user.setAbout("account has been created with github");
                 }else{
                    // facebbok
                    // facebook attributes
            ...
            //     //Crete user and save in database
            ...
            //    }
               ...
               if(user2==null){
                userRepo.save(user);
                logger.info("User Save" + user.getEmail());
               }
